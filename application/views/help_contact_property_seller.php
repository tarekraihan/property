		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I contact a property seller?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p>On the property listing page, there is a box titled <strong>Contact Seller</strong> located on the right hand side of the page. Inside the box you will find the name and phone number of the seller.  You can also click on the <strong>'Ask a Question'</strong> link to send the seller a message online.</p>						<!-- END Help Insert -->
							</div>
