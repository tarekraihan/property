		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I change my profile picture?</h3>
							...
							<!-- START Help Insert -->
								...
								<p class="black"><strong>Instructions</strong></p>
								...
								<ol class="black">
									...
									<li>You are now on a page marked <strong>Person Profile</strong>.  One of the settings boxes is marked <strong>General</strong>, click <strong>'Edit'</strong> located in the top right hand corner of the box.</li>
									<li>Edit your <strong>First Name</strong> and <strong>Last Name</strong> as required. Scroll to the bottom of the page and click <strong>'Save'</strong> when you're finished.</li>
								</ol>						
								<!-- END Help Insert -->
							</div>
