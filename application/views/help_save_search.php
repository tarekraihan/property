		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I save a search?</h3>
							...
							<!-- START Help Insert -->
								<p>Please note that these step-by-step instructions assume that you are currently signed into <strong>Vistamaison.com</strong>. If you're not currently signed in, <a href="<?php echo base_url();?>en/dashboard/">sign in now</a> before continuing.</p>
									...
									<p>From any search result page click the <strong>'Save Your Search'</strong> button located on the right hand side of the page. You may be prompted to select a search name.</p>							<!-- END Help Insert -->
							</div>
