		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I delete my Vista Maisonaccount account?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p class="black">Sorry, at the moment we don't have an automated system for deleting accounts from the system.  We're working on it! We take privacy very seriously.  If you'd like to have your account deleted please <a href="<?php echo base_url();?>en/help_contact/">contact</a> our national head office, we'd be happy to help.</p>
<p>You will be unable to sign in to PropertyGuys.com in the future if your account is deleted.</p>
<p>Please note that if you have listed a property or otherwise made a purchase from PropertyGuys.com your account access will be deactivated but your transaction records will be kept on file.</p>
							<!-- END Help Insert -->
							</div>
