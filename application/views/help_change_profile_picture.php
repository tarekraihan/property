					...
					<div class="col-md-6">
							...
							<!-- START Help Insert -->
								...
								<ol class="black">
									...
									<li>You are now on a page marked <strong>Person Profile</strong>.  There is a menu on the right hand side called the <strong>Person Menu</strong>. Click on <strong>'Photo'</strong>.</li>
									<li>Click <strong>'Browse'</strong> and select a file from your hard drive. The file must be <strong>.JPG</strong>, <strong>.GIF</strong> or <strong>.PNG</strong> file no larger than <strong>1,024kb</strong> in size. Click <strong>'Save'</strong> when you're finished.</li>
								</ol>							
								<!-- END Help Insert -->
							</div>
