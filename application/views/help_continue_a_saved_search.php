		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I continue a saved search?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p>Please note that these step-by-step instructions assume that you are currently signed into <strong>Vistamaison.com</strong>. If you're not currently signed in, <a href="<?php echo base_url();?>en/dashboard/">sign in now</a> before continuing.</p>
								<p>To view a list of your saved searches at any time, click on <strong>'Saved Searches'</strong> at the very top of this page, above the orange search box. If there is an orange number next to the link, it represents the number of searches you currently have saved.</p>
								<p>Click <strong>'View'</strong> beside the name of the search that you would like to view the results of to continue.</p>							<!-- END Help Insert -->
							</div>
