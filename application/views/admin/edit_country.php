	 ...
	 <div class="box col-md-5">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Insert Country</h2>
            ...
            <div class="box-content">
                <form role="form"  action="" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" name="txtCountry" class="form-control"  placeholder="Write Contry">
                    </div>
                    <div class="form-group">
      ...
      <div class="box col-md-5">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2> <i class="glyphicon glyphicon-th-list"></i> Country List</h2>
            </div>
            <div class="box-content">
                <table class="table">
                    <thead>
