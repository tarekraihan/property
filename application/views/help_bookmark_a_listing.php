		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I bookmark a listing?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p class="black">Please note that these step-by-step instructions assume that you are currently signed into <strong>Vistamaison.com </strong>. If you're not currently signed in, <a href="<?php echo base_url();?>en/dashboard/">sign in now</a> before continuing.</p>
								<p class="black"><strong>From search results:</strong></p>
								<p class="black">Beneath the photo of the property, and to the right of the price you will find a star shaped icon.  Clicking on the star icon once will bookmark the listings.</p>
								<p class="black">Listings which have been bookmarked will have their star icon turn yellow in colour. You can click the yellow star icon again to remove the bookmark from the property, the icon will return to a gray colour.</p>
								<p class="black"><strong>From a property listing:</strong></p>
								<p class="black">On the property listing page, located as part of the <strong>Do Stuff</strong> menu, on the right hand side is a star shaped button with the word <strong>Bookmark</strong> beneath it. Click on the star icon, or Bookmark to bookmark the listing.</p>
								<p class="black">If a property has already been bookmarked the star will be larger than the other icons and the word <strong>Bookmarked</strong> will appear in orange beneath the star. You can click the star again to remove the bookmark.</p>							<!-- END Help Insert -->
							</div>
