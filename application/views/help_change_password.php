		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">How do I change my password?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p>Please note that these step-by-step instructions assume that you are currently signed into <strong>PropertyGuys.com</strong>. If you're not currently signed in, <a href="<?php echo base_url();?>en/dashboard/">sign in now</a> before continuing.</p>
								<p><strong>Instructions</strong></p>

								<ol>
									<li>Click on <strong>'My Dashboard'</strong> at the very top of this page, above the orange search box.</li>
									<li>From the dashboard, click on the <strong>'Profile'</strong> menu item, just below the orange search box.</li>
									<li>You are now on a page marked <strong>Person Profile</strong>.  One of the settings boxes is marked <strong>Password</strong>, click <strong>'Edit'</strong> located in the top right hand corner of the box.</li>
									<li>Enter a new password in both the <strong>New Password</strong> and <strong>Password Again</strong>, they must match. Click <strong>'Save'</strong> when you're finished.</li>
								</ol>

								<p>If you've forgotten your password, you can <a href="<?php echo base_url();?>en/dashboard/">request a new password</a>.</p> 							<!-- END Help Insert -->
							</div>
					...
					<div class="col-md-6">
						<h3 class="drop black">Popular Questions</h3>
							<ul class="faq">
								<li><a href="/help/article/id/2">How do I change my email address?</a></li>
								<li><a href="/help/article/id/6">How do I change my profile picture?</a></li>
								<li><a href="/help/article/id/3">How do I delete my Vista Maisonaccount account?</a></li>
								<li><a href="/help/article/id/25">How do I bookmark a listing?</a></li>
							</ul>
