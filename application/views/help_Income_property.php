		...
		<div class="row no-margin">
			<div class="container">
				...
				<div id="left">
					...
					<div class="col-md-6">
							<h3 class="drop black">What does 'Income Property' mean?</h3>
							
							<div id="helpdoc">
							<!-- START Help Insert -->
								<p>Properties marked with an <strong>Income Property</strong> tag are currently capable of being used for rental purposes and conform to all municipal rental bylaws. They may also be lived in, but they are currently setup to be used as income generating properties.</p>					<!-- END Help Insert -->
							</div>
